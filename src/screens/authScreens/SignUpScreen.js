...
const SignUpScreen = ({navigation}) => {
  const [passwordFoucussed, setPasswordFoucussed] = useState(false);
          ...
          {props => (
            <View style={styles.view2}>
              ...
              <View style={styles.view14}>
                <Animatable.View
                  animation={passwordFoucussed ? 'fadeInRight' : 'fadeInLeft'}
                  duration={400}>
                  <Icon
                    name="lock"
                    color={color.grey3}
...
const styles = StyleSheet.create({
  ...
  text1: {fontSize: 22, color: color.buttons, fontWeight: 'bold'},
  ...
  text3: {fontSize: 13, color: color.grey3},
  ...
  text5: {fontSize: 15, fontWeight: 'bold', color: 'black'},
